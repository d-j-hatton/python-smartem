...
def make_relion_folders(tmp_path):
    ...
    with open(
            tmp_path / "CtfFind/job001/micrographs_ctf.star",
            "w"
    ) as f:
        f.write(
            "data_micrographs\nloop_\n"
    ...
    with open(
            tmp_path / "Class2D/job001/run_it020_data.star",
            "w"
    ) as f:
        f.write(
            "data_particles\nloop_\n"
    ...
    with open(
            tmp_path / "Class2D/job001/run_it020_model.star",
            "w"
    ) as f:
        f.write(
            "data_model_classes\nloop_\n"
